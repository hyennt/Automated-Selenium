...
WebUI.click(findTestObject('New Folder (3)/Page_OrangeHRM/input__btnSave'))

WebUI.click(findTestObject('New Folder (3)/Page_OrangeHRM/div_Successfully Saved       Close'))
